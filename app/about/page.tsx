...
const Page = () => {
  return (
    <div>
      <div className="h-screen md:h-screen lg:grid grid-cols-2 gap-4 items-start p-10 md:p-20 relative">
        <div className=" flex md:items-start md:h-full">
          <h1 className="text-[80px] md:text-[120px] text-left md:text-center my-8 md:my-20 leading-[80px] md:leading-normal">
            About Me
          </h1>
        </div>
